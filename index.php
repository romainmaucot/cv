						...
						<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							<ul class="list" style="max-width: 520px;" >
								<li>
									...
									<div class="media">
										<div class="d-flex">
											<p>Novembre 2018 à 2020</p>
										</div>
										<div class="media-body">
											<h4>Ecole IPSSI</h4>
											<p>Bac+4 <br>Alternance<br> Développeur web & mobile<br>Paris</p>
										</div>
									</div>
								</li>
								<li>
									...
									<div class="media">
										<div class="d-flex">
											<p>Septembre 2017 à 2018</p>
										</div>
										<div class="media-body">
											<h4>Simplon.co</h4>
											<p>Formation professionnelle<br />Développeur web & mobile<br>&Eacute;pinal</p>
										</div>
									</div>
								</li>
								<li>
							...
							<ul class="list">
								<li>
									...
									<div class="media">
										...
										<div class="media-body">
											<h4>Agence surf</h4>
											<p>Développeur web & mobile en alternance<br />Paris</p>
										</div>
									</div>
								</li>
                                <li>
								...
								<li>
									...
									<div class="media">
										...
										<div class="media-body">
											<h4>Moon Parade</h4>
											<p>Stage développeur web<br />&Eacute;pinal</p>
										</div>
									</div>
								</li>
							</ul>
        	...
        	<div class="container">
        		...
        		<div class="feature_inner row">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                            <img class="img-thumbnail" src="img/skills/composer.png">
                        </div>
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                        ...
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                            <img class="img-thumbnail" src="img/skills/postgre.png">
                        </div>
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                        ...
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                            <img class="img-thumbnail" src="img/skills/html.png">
                        </div>
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                            <img class="img-thumbnail" src="img/skills/css.png">
                        </div>
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                        ...
                        <div class="col-md-2 col-3 col-sm-3 mt-4">
                            <img class="img-thumbnail" src="img/skills/in.png">
                        </div>
                        <div class="col-md-2 col-3 col-sm-3 mt-4 text-center">
                            <img class="img-thumbnail mt-3" src="img/skills/etcetera.png" width="65%">
                        </div>
                    </div>
        		</div>
        	</div>
